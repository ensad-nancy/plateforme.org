...
'
		...
		$(\'.formulaire_spip' .
interdire_scripts(((lire_config('forums_afficher_barre',null,false) == 'non') ? ':not(#formulaire_forum)':'')) .
' textarea[name=texte]\')
