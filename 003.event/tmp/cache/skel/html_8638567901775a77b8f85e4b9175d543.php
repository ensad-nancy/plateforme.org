...
// Temps de compilation total: 29.674 ms
//
...
div.pense-bete, a.pense-bete { background: url(' .
(is_array($a = ($Pile["vars"])) ? $a['chemin_img_pack'] : "") .
'm_envoi_bleu' .
(is_array($a = ($Pile["vars"])) ? $a['rtl'] : "") .
'.gif) center ' .
...
div.annonce, a.annonce { background: url(' .
(is_array($a = ($Pile["vars"])) ? $a['chemin_img_pack'] : "") .
'm_envoi_jaune' .
(is_array($a = ($Pile["vars"])) ? $a['rtl'] : "") .
'.gif) center ' .
...
div.message, a.message { background: url(' .
(is_array($a = ($Pile["vars"])) ? $a['chemin_img_pack'] : "") .
'm_envoi' .
(is_array($a = ($Pile["vars"])) ? $a['rtl'] : "") .
'.gif) center ' .
...
/* agenda */
table.calendrier th { background: ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
'; }
table.calendrier td { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
';}
tr.calendrier-3jours > td[colspan] { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
';}
tr.calendrier-3jours > td { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
';}
tr.calendrier-3jours > td+td+td { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
';}
tr.calendrier-3jours > td+td+td+td+td { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
';}

table.calendrier tr.heure td { border: 0 }
.calendrier-jour { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
'; border-right: 0;}
.calendrier-msg { border: 1px solid ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
';}
...
table.calendrier-cadreagenda { background: ' .
(is_array($a = ($Pile["vars"])) ? $a['claire'] : "") .
'; }
table.calendrier caption { background-color: ' .
(is_array($a = ($Pile["vars"])) ? $a['foncee'] : "") .
'; }
