...
/*
 * Squelette : ../extensions/spip-bonux/style_prive_plugins.html
 * Date :      Mon, 05 Dec 2011 10:20:16 GMT
 * Compile :   Mon, 05 Dec 2011 10:22:44 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../extensions/spip-bonux/style_prive_plugins.html
// Temps de compilation total: 4.327 ms
//

function html_df4040b3c7ba84d0b3fb19f7818d9f8a($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
recuperer_fond( tous_les_fonds('prive/','/style_prive_plugin_') , array_merge($Pile[0],array('couleur_claire' => @$Pile[0]['couleur_claire'] ,
	...
	'ltr' => @$Pile[0]['ltr'] ,
	'lang' => $GLOBALS["spip_lang"] )), array('compil'=>array('../extensions/spip-bonux/style_prive_plugins.html','html_df4040b3c7ba84d0b3fb19f7818d9f8a','',61,$GLOBALS['spip_lang'])), '') .
'
');

	return analyse_resultat_skel('html_df4040b3c7ba84d0b3fb19f7818d9f8a', $Cache, $page, '../extensions/spip-bonux/style_prive_plugins.html');
}
?>